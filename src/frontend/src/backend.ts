...
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: bigint, arg1: string, arg2: string): Promise<bigint> {
    ...
    async addMultipleEntries(arg0: Array<[bigint, string, string]>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addMultipleEntries(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllEntries(): Promise<Array<CoordEntry>> {
        if (this.processError) {
            try {
    ...
    async removeEntry(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
